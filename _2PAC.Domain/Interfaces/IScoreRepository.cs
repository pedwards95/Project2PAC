...
// ! CLASS SPECIFIC
        ...
        /// </summary>
        L_Score GetScoreById(int scoreId);
        ...
        /// <returns> void </returns>
        /// </summary>
        void UpdateScore(L_Score inputScore);
// ! RELATED TO OTHER CLASSES
        ...
        /// </summary>
        List<L_Score> GetScoresByGameId(int gameId);
        ...
        /// </summary>
        List<L_Score> GetScoresByUserId(int userId);
